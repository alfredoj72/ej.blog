...
De los 28 municipios que el scraping detectó, en 4 de ellos[^6] el motivo fue que había fallos[^7] en las notas que hubieran permitido detectarlos. En los restantes 24 municipios que no se detectaron, la razón fue similar: son municipios que solo aparecen en el primer censo que registra el INE, el de 1842, y en su nota al pie solo pone algo como "Este municipio que aparece en el Censo de 1842, ..., no se le localiza en el Censo de 1857", pero no dice si se integraron en otro municipio o se volatilizaron, de forma que era imposible detectarlos mediante el proceso de Web scraping.
