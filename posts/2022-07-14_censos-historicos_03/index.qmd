...
-   Se tuvo que repetir este proceso 5 veces hasta que de las notas de la última vuelta no surgieron nuevos códigos municipales. En total había scrappeado un total de 11.882 municipios: 8.120 en la primera vuelta, 2.924 en la segunda, 767, 69, y finalmente 2 nuevos municipios en la quinta y última ronda.
...
[^5]: Los municipios San Quirce de Riopisuerga (09342), Gátova (12066), Rivas de Tereso (26504) y Los Hueros (28511).

De los 28 municipios que el scrapping detectó, en 4 de ellos[^6] el motivo fue que había fallos[^7] en las notas que hubieran permitido detectarlos. En los restantes 24 municipios que no se detectaron, la razón fue similar: son municipios que solo aparecen en el primer censo que registra el INE, el de 1842, y en su nota al pie solo pone algo como "Este municipio que aparece en el Censo de 1842, ..., no se le localiza en el Censo de 1857", pero no dice si se integraron en otro municipio o se volatilizaron, de forma que era imposible detectarlos mediante el proceso de Web scrapping.

[^6]: Los municipios San Quirce de Riopisuerga (09342), Gátova (12066), Rivas de Tereso (26504) y Los Hueros (28511).

[^7]: Concretamente el fallo consistió en que su código municipal en la nota que hubiese permitido detectarlos estaba incompleto, ya que solo tenía 3 dígitos en lugar de los 5 habituales.

Tras este proceso tenía los datos de los 11.910 municipios[^8] que parecen haber existido en España.

[^8]: En realidad debería decir que se detectaron, tras la ayuda de Paco Goerlich, 11.910 códigos municipales únicos, ya que por ejemplo el municipio de Gatova cambió su código de 12066 a 46092 al incorporarse a la provincia de Valencia desde la de Castellón, en el censo de 2001.

## ¿Cifras oficiales de población?

Voy a utilizar estos datos para hacer algunos análisis y visualizaciones, así que cabe preguntarse si son datos "oficiales" de población y si están libres de errores. En principio los datos que he obtenido por Web scrapping de la web del INE deberían ser las "cifras oficiales" de población de los municipios españoles, pero en [Goerlich y otros (2015)](https://www.fbbva.es/publicaciones/cambios-en-la-estructura-y-localizacion-de-la-poblacion-una-vision-de-largo-plazo-1842-2011/){target="_blank"} señalan, concretamente en los apartados 2.2.6, 2.2.7 y 2.2.8, diversos errores de transcripción.

Los datos del INE contienen, tal y como se explica [aquí](https://www.ine.es/intercensal/){target="_blank"}, una tabla para cada uno de los municipios que han sido censados en España desde 1842. Para cada municipio se recogen 3 variables: población de hecho, población de derecho y número de hogares. Además se recogen en las notas determinadas alteraciones municipales. Como ejemplo, [aquí](https://www.ine.es/intercensal/intercensal.do?search=1&error1=Debe+introducir+un+nombre+de+municipio.&error2=Debe+introducir+al+menos+3+caracteres.&cmbTipoBusq=0&textoMunicipio=Pancrudo&btnBuscarDenom=Consultar+selecci%C3%B3n){target="_blank"} puedes ver la tabla para Pancrudo que, como se aprecia en las notas, incorporó a Portalrubio en el censo de 1981.

En la tabla también se aprecia que hay dos variables de población. Utilizaré la **población de derecho**, salvo en los censos de 1857 y 1860 en los que como no hay registro para la población de derecho, la sustituiré por la de hecho, para así tener una serie completa de población para todos los censos del periodo 1842-2011. Es posible que en algunos análisis añada también los datos del Padrón (1998-2021).

Supongo que un historiador podrá decir mucho sobre la validez, cambios de criterios y demás infortunios acaecidos a lo largo de los distintos censos. Yo aquí voy a dar por buenos los datos (son del INE!!), ya que mi objetivo es, además de satisfacer mi curiosidad, tener otro conjunto de datos para mis cursos. Sé que en las tablas del INE hay errores de transcripción[^9], pero esos errores prácticamente no afectan a los análisis y visualizaciones que haré aquí. En concreto, los errores detectados que afectan a las capitales de provincia son menores, solo detectándose diferencias importantes en Ceuta, Melilla y Madrid en el censo de 1991[^10], así que para los análisis qye voy a hacer en el blog doy por buenos los datos que figuran [aquí](https://www.ine.es/dyngs/INEbase/es/operacion.htm?c=Estadistica_C&cid=1254736176998&menu=resultados&idp=1254735572981){target="_blank"} en la web del INE.

[^9]: Esos errores de describen en detalle en los apartados 2.2.6, 2.2.7 y 2.2.8 de [este libro](https://www.fbbva.es/publicaciones/cambios-en-la-estructura-y-localizacion-de-la-poblacion-una-vision-de-largo-plazo-1842-2011/){target="_blank"}
...
Tampoco voy a tratar de corregir la población por las alteraciones municipales que hayan ocurrido; es decir no trato de obtener series homogéneas de población.
...
Según mis cuentas, en realidad según los códigos municipales únicos que he encontrado en la web de los censos históricos del INE, han existido[^12] en España **11.910 municipios**[^13], pero resulta que el último censo es de 2011, así que se han podido crear más municipios hasta la actualidad (2022). Sí, desde 2011 a 2022 se crearon en España 16 municipios por lo que la final answer es: **han existido 11.926 municipios** en Spain.

[^12]: En realidad han sido censados

[^13]: Hay que recordar que un municipio puede englobar a varios "pueblos" o localidades; por ejemplo, el [municipio de Pancrudo](https://es.wikipedia.org/wiki/Pancrudo) engloba actualmente 4 pueblos: Pancrudo, Portalrubio, Cuevas de Portalrubio y Cervera del Rincón.

¿Cuantos municipios han desaparecido? Pues como en 2021 había 8.131 municipios en el Padrón, desde el censo de 1842, han desparecido en España 3.795 municipios.
...
-   artículo PAIS: <https://verne.elpais.com/verne/2021/03/01/articulo/1614584363_382946.html>
