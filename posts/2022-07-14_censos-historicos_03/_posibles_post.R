#- los scripts los tengo en mi web (xq he hecho/estoy haciendo) algunos posts
library(tidyverse)
...
#- ciudades que han estado en el TOP 20 alguna vez
#- importancia histórica de las provincias (en cuanto a población)
#- importancia histórica de las capitales de provincia
#- ¿Está más concentrada la población? 50%

#- Este grafico: https://twitter.com/_ansgar/status/1538167029114580992